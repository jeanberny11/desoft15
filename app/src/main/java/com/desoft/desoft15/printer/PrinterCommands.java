...
public class PrinterCommands {
    ...
    public static final int MAXNORMALCHAR=32;
    public static final int MAXSMALLCHAR=42;
    public static final int MAXEXTRABIGCHAR=12;
    public static final int MAXBIGCHAR=16;
    public static final byte[] INIT = {27, 64};
    public static byte[] FEED_LINE = {10};
    public static byte[] ESC_RESET=new byte[]{0x1B,0x40};
    public static int barcodeAlign=0;
    public static int barcodeHeight=162;
    public static int barcodeHriCode=0;
    public static int barcodeHriFont=0;
    public static int barcodeScale=3;
    ...
    public static final byte[] SPAINCHARSET= new byte[]{27,82,7};
