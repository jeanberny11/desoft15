...
public class SunmiPrintHelper {
    ...
    public void printColumnsString(String[] columntexts,int[] widths,int[] aligns,boolean isBold){
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
        try {
            ...
            sunmiPrinterService.printColumnsString(columntexts, widths, aligns, null);
            try {
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine,
        ...
        try {
            ...
            sunmiPrinterService.sendRAWData(ESCUtil.alignLeft(), null);
            sunmiPrinterService.sendRAWData(ESCUtil.boldOff(), null);
            sunmiPrinterService.sendRAWData(ESCUtil.underlineOff(), null);
        } catch (RemoteException e) {
            e.printStackTrace();
